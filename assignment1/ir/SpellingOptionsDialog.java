...
public class SpellingOptionsDialog {
  ...
  /**
   * Show the dialog window with a dropdown menu with a <code>possibilities</code> presented in the
   * exact order as they are provided with <code>defaultOption</code> being chosen by default.
   */
